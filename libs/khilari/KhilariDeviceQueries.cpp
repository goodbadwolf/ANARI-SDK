...
const char **query_object_types(ANARIDataType type)
{
  ...
  case ANARI_CAMERA: {
    static const char *ANARI_CAMERA_subtypes[] = {
        "default", "omnidirectional", "orthographic", "perspective", 0};
  ...
  case ANARI_INSTANCE: {
    static const char *ANARI_INSTANCE_subtypes[] = {
        "motionScaleRotationTranslation", "motionTransform", "transform", 0};
  ...
  case ANARI_SAMPLER: {
    static const char *ANARI_SAMPLER_subtypes[] = {
        "image1D", "image2D", "image3D", "primitive", "transform", 0};
...
static const void *ANARI_CAMERA_default_shutter_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_default_apertureRadius_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_default_focusDistance_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_default_motion_transform_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  {
    static const char *description =
        "world space transforms uniformly distributed in time";
    return description;
  }
  case 5: // elementType
    if (infoType == ANARI_DATA_TYPE_LIST) {
...
static const void *ANARI_CAMERA_default_motion_scale_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_default_motion_rotation_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  case 5: // elementType
    if (infoType == ANARI_DATA_TYPE_LIST) {
      static const ANARIDataType values[] = {
          ANARI_FLOAT32_QUAT_IJKW, ANARI_UNKNOWN};
      return values;
    } else {
      return nullptr;
    }
...
static const void *ANARI_CAMERA_default_motion_translation_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  {
    static const char *description =
        "translations uniformly distributed in time";
    return description;
  }
  case 5: // elementType
    if (infoType == ANARI_DATA_TYPE_LIST) {
...
static const void *ANARI_CAMERA_default_time_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  {
    static const char *description =
        "time associated with the first and laste entry in the motion.transform array";
    return description;
  }
  case 7: // sourceExtension
    if (infoType == ANARI_STRING) {
...
static const void *ANARI_CAMERA_default_rollingShutterDirection_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  case 6: // value
    if (paramType == ANARI_STRING && infoType == ANARI_STRING_LIST) {
      static const char *values[] = {
          "none", "left", "right", "down", "up", nullptr};
      return values;
    } else {
      return nullptr;
    }
...
static const void *ANARI_CAMERA_default_rollingShutterDuration_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_default_stereoMode_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_default_interpupillaryDistance_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_default_param_info(const char *paramName,
    ANARIDataType paramType,
    int infoName,
    ANARIDataType infoType)
{
  ...
  case 5:
    return ANARI_CAMERA_default_apertureRadius_info(
        paramType, infoName, infoType);
  case 34:
    return ANARI_CAMERA_default_focusDistance_info(
        paramType, infoName, infoType);
  case 63:
    return ANARI_CAMERA_default_motion_transform_info(
        paramType, infoName, infoType);
  case 62:
    return ANARI_CAMERA_default_motion_scale_info(
        paramType, infoName, infoType);
  case 61:
    return ANARI_CAMERA_default_motion_rotation_info(
        paramType, infoName, infoType);
  case 64:
    return ANARI_CAMERA_default_motion_translation_info(
        paramType, infoName, infoType);
  case 105:
    return ANARI_CAMERA_default_time_info(paramType, infoName, infoType);
  case 88:
    return ANARI_CAMERA_default_rollingShutterDirection_info(
        paramType, infoName, infoType);
  case 89:
    return ANARI_CAMERA_default_rollingShutterDuration_info(
        paramType, infoName, infoType);
  case 102:
    return ANARI_CAMERA_default_stereoMode_info(paramType, infoName, infoType);
  case 51:
    return ANARI_CAMERA_default_interpupillaryDistance_info(
        paramType, infoName, infoType);
  default:
    return nullptr;
  }
...
static const void *ANARI_ARRAY1D_region_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_FRAME_channel_albedo_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  case 6: // value
    if (paramType == ANARI_DATA_TYPE && infoType == ANARI_DATA_TYPE_LIST) {
      static const ANARIDataType values[] = {ANARI_UFIXED8_VEC3,
...
static const void *ANARI_FRAME_channel_instanceId_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  {
    static const char *description =
        "enables mapping the instanceId channel as the type specified";
    return description;
  }
  case 6: // value
    if (paramType == ANARI_DATA_TYPE && infoType == ANARI_DATA_TYPE_LIST) {
...
static const void *ANARI_FRAME_channel_normal_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  case 6: // value
    if (paramType == ANARI_DATA_TYPE && infoType == ANARI_DATA_TYPE_LIST) {
      static const ANARIDataType values[] = {
          ANARI_FIXED16_VEC3, ANARI_FLOAT32_VEC3, ANARI_UNKNOWN};
      return values;
    } else {
      return nullptr;
    }
...
static const void *ANARI_FRAME_channel_objectId_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  {
    static const char *description =
        "enables mapping the objectId channel as the type specified";
    return description;
  }
  case 6: // value
    if (paramType == ANARI_DATA_TYPE && infoType == ANARI_DATA_TYPE_LIST) {
...
static const void *ANARI_FRAME_channel_primitiveId_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  {
    static const char *description =
        "enables mapping the primitiveId channel as the type specified";
    return description;
  }
  case 6: // value
    if (paramType == ANARI_DATA_TYPE && infoType == ANARI_DATA_TYPE_LIST) {
...
static const void *ANARI_FRAME_frameCompletionCallback_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_FRAME_frameCompletionCallbackUserData_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
    ...
    ANARIDataType infoType)
{
  ...
  case 36:
    return ANARI_FRAME_frameCompletionCallback_info(
        paramType, infoName, infoType);
  case 37:
    return ANARI_FRAME_frameCompletionCallbackUserData_info(
        paramType, infoName, infoType);
  default:
    return nullptr;
  }
    ...
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  ...
  {
    static const char *description =
        "the amount of light emitted by a point on the ambient light source in a direction, in W/sr/m^2";
    return description;
  }
  case 7: // sourceExtension
    if (infoType == ANARI_STRING) {
...
static const void *ANARI_RENDERER_default_volumeSampleRateFactor_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
    ...
    ANARIDataType infoType)
{
  ...
  case 10:
    return ANARI_RENDERER_default_background_info(
        paramType, infoName, infoType);
  case 124:
    return ANARI_RENDERER_default_volumeSampleRateFactor_info(
        paramType, infoName, infoType);
  default:
    return nullptr;
  }
...
static const void *ANARI_SURFACE_id_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionScaleRotationTranslation_name_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionScaleRotationTranslation_transform_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionScaleRotationTranslation_group_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *
ANARI_INSTANCE_motionScaleRotationTranslation_motion_scale_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *
ANARI_INSTANCE_motionScaleRotationTranslation_motion_rotation_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *
ANARI_INSTANCE_motionScaleRotationTranslation_motion_translation_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionScaleRotationTranslation_time_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionScaleRotationTranslation_id_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionScaleRotationTranslation_param_info(
    ...
    ANARIDataType infoType)
{
  switch (param_hash(paramName)) {
  case 65:
    return ANARI_INSTANCE_motionScaleRotationTranslation_name_info(
        paramType, infoName, infoType);
  case 106:
    return ANARI_INSTANCE_motionScaleRotationTranslation_transform_info(
        paramType, infoName, infoType);
  case 39:
    return ANARI_INSTANCE_motionScaleRotationTranslation_group_info(
        paramType, infoName, infoType);
  case 62:
    return ANARI_INSTANCE_motionScaleRotationTranslation_motion_scale_info(
        paramType, infoName, infoType);
  case 61:
    return ANARI_INSTANCE_motionScaleRotationTranslation_motion_rotation_info(
        paramType, infoName, infoType);
  case 64:
    return ANARI_INSTANCE_motionScaleRotationTranslation_motion_translation_info(
        paramType, infoName, infoType);
  case 105:
    return ANARI_INSTANCE_motionScaleRotationTranslation_time_info(
        paramType, infoName, infoType);
  case 41:
    return ANARI_INSTANCE_motionScaleRotationTranslation_id_info(
        paramType, infoName, infoType);
  default:
    return nullptr;
  }
}
static const void *ANARI_INSTANCE_motionTransform_name_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionTransform_transform_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionTransform_group_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionTransform_motion_transform_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionTransform_time_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_motionTransform_param_info(
    const char *paramName,
    ANARIDataType paramType,
    int infoName,
    ANARIDataType infoType)
{
  switch (param_hash(paramName)) {
  case 65:
    return ANARI_INSTANCE_motionTransform_name_info(
        paramType, infoName, infoType);
  case 106:
    return ANARI_INSTANCE_motionTransform_transform_info(
        paramType, infoName, infoType);
  case 39:
    return ANARI_INSTANCE_motionTransform_group_info(
        paramType, infoName, infoType);
  case 63:
    return ANARI_INSTANCE_motionTransform_motion_transform_info(
        paramType, infoName, infoType);
  case 105:
    return ANARI_INSTANCE_motionTransform_time_info(
        paramType, infoName, infoType);
  default:
    return nullptr;
  }
}
static const void *ANARI_INSTANCE_transform_name_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_transform_transform_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_transform_group_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_INSTANCE_transform_param_info(const char *paramName,
    ANARIDataType paramType,
    int infoName,
    ANARIDataType infoType)
{
  ...
  case 106:
    return ANARI_INSTANCE_transform_transform_info(
        paramType, infoName, infoType);
  case 39:
...
static const void *ANARI_VOLUME_transferFunction1D_id_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
    ...
    ANARIDataType infoType)
{
  ...
  case 108:
    return ANARI_VOLUME_transferFunction1D_unitDistance_info(
        paramType, infoName, infoType);
  case 41:
    return ANARI_VOLUME_transferFunction1D_id_info(
        paramType, infoName, infoType);
  default:
    return nullptr;
  }
...
static const void *ANARI_CAMERA_omnidirectional_name_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_omnidirectional_position_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_omnidirectional_direction_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_omnidirectional_up_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_omnidirectional_imageRegion_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_omnidirectional_layout_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_CAMERA_omnidirectional_param_info(
    const char *paramName,
    ANARIDataType paramType,
    int infoName,
    ANARIDataType infoType)
{
  switch (param_hash(paramName)) {
  case 65:
    return ANARI_CAMERA_omnidirectional_name_info(
        paramType, infoName, infoType);
  case 74:
    return ANARI_CAMERA_omnidirectional_position_info(
        paramType, infoName, infoType);
  case 27:
    return ANARI_CAMERA_omnidirectional_direction_info(
        paramType, infoName, infoType);
  case 109:
    return ANARI_CAMERA_omnidirectional_up_info(paramType, infoName, infoType);
  case 43:
    return ANARI_CAMERA_omnidirectional_imageRegion_info(
        paramType, infoName, infoType);
  case 57:
    return ANARI_CAMERA_omnidirectional_layout_info(
        paramType, infoName, infoType);
  default:
    return nullptr;
  }
...
static const void *ANARI_GEOMETRY_quad_time_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_GEOMETRY_triangle_time_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_name_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_image_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_inAttribute_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_filter_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_wrapMode1_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_wrapMode2_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_wrapMode3_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_inTransform_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_inOffset_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_outTransform_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_outOffset_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_image3D_param_info(const char *paramName,
    ANARIDataType paramType,
    int infoName,
    ANARIDataType infoType)
{
  ...
  case 44:
    return ANARI_SAMPLER_image3D_inAttribute_info(
        paramType, infoName, infoType);
  case 33:
  ...
  case 46:
    return ANARI_SAMPLER_image3D_inTransform_info(
        paramType, infoName, infoType);
  case 45:
    return ANARI_SAMPLER_image3D_inOffset_info(paramType, infoName, infoType);
  case 73:
    return ANARI_SAMPLER_image3D_outTransform_info(
        paramType, infoName, infoType);
  case 72:
...
static const void *ANARI_SAMPLER_primitive_name_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_primitive_array_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_primitive_inOffset_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_primitive_param_info(const char *paramName,
    ANARIDataType paramType,
    int infoName,
    ANARIDataType infoType)
{
...
static const void *ANARI_SAMPLER_transform_name_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_transform_inAttribute_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_transform_outTransform_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
...
static const void *ANARI_SAMPLER_transform_outOffset_info(
    ANARIDataType paramType, int infoName, ANARIDataType infoType)
{
  (void)paramType;
  switch (infoName) {
  ...
  case 1: // default
    if (paramType == ANARI_FLOAT32_MAT4 && infoType == ANARI_FLOAT32_MAT4) {
      static const float default_value[16] = {
          0.000000f, 0.000000f, 0.000000f, 0.000000f};
      return default_value;
    } else {
      return nullptr;
...
static const void *ANARI_SAMPLER_transform_param_info(const char *paramName,
    ANARIDataType paramType,
    int infoName,
    ANARIDataType infoType)
{
  ...
  case 44:
    return ANARI_SAMPLER_transform_inAttribute_info(
        paramType, infoName, infoType);
  case 73:
    return ANARI_SAMPLER_transform_outTransform_info(
        paramType, infoName, infoType);
  case 72:
    return ANARI_SAMPLER_transform_outOffset_info(
        paramType, infoName, infoType);
  default:
    return nullptr;
  }
    ...
    ANARIDataType infoType)
{
  ...
  case 3:
    return ANARI_CAMERA_default_param_info(
        paramName, paramType, infoName, infoType);
  case 12:
    return ANARI_CAMERA_omnidirectional_param_info(
        paramName, paramType, infoName, infoType);
  case 13:
...
static const void *ANARI_INSTANCE_param_info(const char *subtype,
    const char *paramName,
    ANARIDataType paramType,
    int infoName,
    ANARIDataType infoType)
{
  switch (subtype_hash(subtype)) {
  case 10:
    return ANARI_INSTANCE_motionScaleRotationTranslation_param_info(
        paramName, paramType, infoName, infoType);
  case 11:
    return ANARI_INSTANCE_motionTransform_param_info(
        paramName, paramType, infoName, infoType);
  case 24:
    return ANARI_INSTANCE_transform_param_info(
        paramName, paramType, infoName, infoType);
  default:
    return nullptr;
  }
    ...
    ANARIDataType infoType)
{
  ...
  case 7:
    return ANARI_SAMPLER_image2D_param_info(
        paramName, paramType, infoName, infoType);
  case 8:
    return ANARI_SAMPLER_image3D_param_info(
        paramName, paramType, infoName, infoType);
  case 17:
    return ANARI_SAMPLER_primitive_param_info(
        paramName, paramType, infoName, infoType);
  case 24:
    return ANARI_SAMPLER_transform_param_info(
        paramName, paramType, infoName, infoType);
  default:
    return nullptr;
  }
    ...
    ANARIDataType infoType)
{
  ...
  case ANARI_GEOMETRY:
    return ANARI_GEOMETRY_param_info(
        subtype, paramName, paramType, infoName, infoType);
  case ANARI_INSTANCE:
    return ANARI_INSTANCE_param_info(
        subtype, paramName, paramType, infoName, infoType);
  case ANARI_LIGHT:
...
static const void *ANARI_CAMERA_default_info(
    int infoName, ANARIDataType infoType)
{
  switch (infoName) {
  case 9: // parameter
...
static const void *ANARI_FRAME_info(int infoName, ANARIDataType infoType)
{
  ...
  case 10: // channel
    if (infoType == ANARI_STRING_LIST) {
      static const char *channel[] = {"channel.color",
          "channel.depth",
          "channel.albedo",
          "channel.instanceId",
          "channel.normal",
...
static const void *ANARI_INSTANCE_motionScaleRotationTranslation_info(
    int infoName, ANARIDataType infoType)
{
  switch (infoName) {
  case 4: // description
  {
    static const char *description =
        "motion instance object with separate scale, rotation and translation";
    return description;
  }
  case 9: // parameter
    if (infoType == ANARI_PARAMETER_LIST) {
...
static const void *ANARI_INSTANCE_motionTransform_info(
    int infoName, ANARIDataType infoType)
{
  switch (infoName) {
  case 4: // description
...
static const void *ANARI_LIGHT_spot_info(int infoName, ANARIDataType infoType)
{
  ...
  case 9: // parameter
    if (infoType == ANARI_PARAMETER_LIST) {
      static const ANARIParameter parameters[] = {{"visible", ANARI_BOOL},
          {"name", ANARI_STRING},
          {"color", ANARI_FLOAT32_VEC3},
          {"position", ANARI_FLOAT32_VEC3},
          {"direction", ANARI_FLOAT32_VEC3},
...
static const void *ANARI_CAMERA_omnidirectional_info(
    int infoName, ANARIDataType infoType)
{
  switch (infoName) {
  case 4: // description
...
static const void *ANARI_SAMPLER_image3D_info(
    int infoName, ANARIDataType infoType)
{
  switch (infoName) {
  case 4: // description
...
static const void *ANARI_SAMPLER_primitive_info(
    int infoName, ANARIDataType infoType)
{
  switch (infoName) {
  case 4: // description
...
static const void *ANARI_SAMPLER_transform_info(
    int infoName, ANARIDataType infoType)
{
  switch (infoName) {
  case 4: // description
...
static const void *ANARI_INSTANCE_info(
    const char *subtype, int infoName, ANARIDataType infoType)
{
  switch (subtype_hash(subtype)) {
  case 10:
    return ANARI_INSTANCE_motionScaleRotationTranslation_info(
        infoName, infoType);
  case 11:
