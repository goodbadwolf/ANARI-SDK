...
struct KhilariDevice : public helium::BaseDevice
{
  /////////////////////////////////////////////////////////////////////////////
  ...
  KhilariDevice(ANARIStatusCallback defaultCallback, const void *userPtr);
  KhilariDevice(ANARILibrary);
  ~KhilariDevice() override;
 ...
 private:
  KhilariGlobalState *deviceState() const;
  ...
  T nextHandle()
  {
    ...
    objects.emplace_back(new Object(anari::ANARITypeFor<T>::value));
